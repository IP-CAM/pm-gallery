...
$data['languages'] = $this->model_localisation_language->getLanguages();
    ...
    $language_info = $this->language->load('catalog/pm_gallery');
		...
		$lang =  $this->model_localisation_language->getLanguages();
                                    $data['pm_gallery_description'] = $this->model_catalog_pm_gallery->getKoschtitGallery($lang);

		if(!$data['pm_gallery_description']){
         $data['action'] = $this->url->link('catalog/pm_gallery/insert','module_id=' . $module_id . '&token=' . $this->session->data['token'], 'SSL');
     }
		else{
         $data['action'] = $this->url->link('catalog/pm_gallery/update','module_id=' . $module_id . '&token=' . $this->session->data['token'], 'SSL');
    }
    ...
    $this->response->setOutput($this->load->view('catalog/pm_gallery_setting_form.tpl', $data));
	}
   */
